...
DanceApp::DanceApp() : GraphicsApp(1280,768, "So You Think Ants Can Dance") {
    ...
    // 2. Load the raw motion clips
    MotionClip sword_motion;

    ballet_special2_.LoadFromAMC(Platform::FindFile("02_09.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special2_.TrimBack(200);
    ballet_special2_.MakeLoop(50);
    ballet_special2_.CalcRelativeTranslations();
    

    // 3. Start the base loop motion
    ballet_ant_.Play(ballet_special2_);
    
    sword_ant_transform = Matrix4::Translation(Vector3(0.5, 2, 0.5));
    ...
    ballet_special3_.LoadFromAMC(Platform::FindFile("29_18.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special3_.TrimBack(200);
    ballet_special3_.MakeLoop(50);
    ballet_special3_.CalcRelativeTranslations();


    // 3. Start the base loop motion
    ballet_ant_.Play(ballet_special3_);
    ...
    ballet_special4_.LoadFromAMC(Platform::FindFile("32_16.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special4_.TrimBack(200);
    ballet_special4_.MakeLoop(50);
    ballet_special4_.CalcRelativeTranslations();


    // 3. Start the base loop motion
    ballet_ant_.Play(ballet_special4_);
    ...
    ballet_special5_.LoadFromAMC(Platform::FindFile("28_17.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    //ballet_special5_.TrimFront(400);
    ballet_special5_.TrimBack(100);
    ballet_special5_.MakeLoop(50);
    ballet_special5_.CalcRelativeTranslations();


    // 3. Start the base loop motion
    ballet_ant_.Play(ballet_special5_);
...
void DanceApp::UpdateSimulation(double dt)  {
    ...
    sword_ant_.AdvanceAnimation(dt);
}
...
void DanceApp::DrawUsingOpenGL() {
    ...
    // Sword ant
    sword_ant_.Draw(sword_ant_transform, viewMatrix_, projMatrix_, false);
